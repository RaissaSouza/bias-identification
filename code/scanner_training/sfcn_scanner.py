...
def add_final_layer(intermediate_model):
    dense_layer=Dense(units=params['number_class'], activation='softmax',name="dense2")(intermediate_model.output)
...
train_IDs = IDs_list
training_generator = DataGenerator(train_IDs,params['batch_size'],(params['imagex'], params['imagey'], params['imagez']),True,fn_train,params['column'],params['number_class'])
...
val_IDs = IDs_list
val_generator = DataGenerator(val_IDs, params['batch_size'],(params['imagex'], params['imagey'], params['imagez']),True,fn_val, params['column'],params['number_class'])
